        ...
        <div class="box box-solid">
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-xs-6"><a href="<?php echo e(route('users.index')); ?>" class="btn btn-flat btn-sm btn-warning pull-right">Back</a></div>
                </div>
                <hr />
...
<?php $__env->startSection('scripts'); ?>
    <script type="text/javascript" src="<?php echo e(asset('adminlte/plugins/input-mask/jquery.inputmask.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('adminlte/plugins/input-mask/jquery.inputmask.date.extensions.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('adminlte/plugins/input-mask/jquery.inputmask.extensions.js')); ?>"></script>
    <script>
        $(function () {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.lte-main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pma_equip\resources\views/manage/users/create.blade.php ENDPATH**/ ?>